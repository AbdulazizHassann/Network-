package Task2TCPAskConnections;
import java.io.*;
import Task2TCPAskConnections.tcpclient.TCPClient;
...
public class TCPAsk {
    ...
    public static void main( String[] args) {
        parseArgs(args);
		try {
			TCPClient tcpClient = new Task2TCPAskConnections.tcpclient.TCPClient(shutdown, timeout, limit);
